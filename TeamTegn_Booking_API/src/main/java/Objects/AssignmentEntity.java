...
public class AssignmentEntity {
    ...
    @Basic
    @Column(name = "DestinationPostCode")
    ...
    @Basic
    @Column(name = "DestinationStateRegion")
    ...
    @Basic
    @Column(name = "ServiceUserAccountID")
    ...
    @Basic
    @Column(name = "ServiceUserAccountEAN")
    ...
    @Basic
    @Column(name = "RecurrencyFrequency")
