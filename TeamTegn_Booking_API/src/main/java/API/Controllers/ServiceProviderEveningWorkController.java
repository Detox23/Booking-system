...
public class ServiceProviderEveningWorkController {
     ...
     * @param serviceProviderEveningWorkForCreationDto <ServiceProviderEveningWorkForUpdateDto> Object that is essential
     *                                                 for completing the operation. Required fields:
     ...
     * @param id <Integer> Unique identifier of the service provider.
     ...
     * @param day <String> Name of a day.
