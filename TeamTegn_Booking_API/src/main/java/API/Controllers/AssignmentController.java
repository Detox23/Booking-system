...
//    }
     ...
     * @param pageNumber [Path variable] <String> defines what page should be shown,
     * @param pageSize [Path variable] <String> defines page size,
     * @param sortBy [Path variable] <String> defines by witch field should the page be sorted,
     * @param sortDirection [Path variable] <String> defines whether sort ascending or descending
     * @return If successfully, it returns a code 302 (FOUND response) with am pageable object of assignments
    ...
    {
        return new ResponseEntity<>(this.assignmentService.listAssignmentsPage(PageRequest.of(pageNumber, pageSize,
                sortDirection, sortBy)), new HttpHeaders(), HttpStatus.FOUND);
    }

    /**
     * GET request method that is responsible for finding an assignment from a database.
     * @param id [Path variable] <Integer> An unique identifier of a record from a database.
     ...
     * @param date [Path variable] <Date> Value defining filtering the assignments with the same date. Example: 2018-05-23
     ...
     * @param assignment [Request body variable] <AssignmentForCreationDto> An object that need to be passed in order to complete the operation.
     ...
     * changed.
     * @param id [Path variable] <Integer> Unique identifier of a record from a database that is used to delete the record.
     ...
     * @param forUpdate [Request body variable] <AssignmentForUpdateDto> An object that need to be passed to complete the operation.
     ...
     * @param id [Path variable] <Integer> Unique identifier of the assignment from a database.
     ...
     * @param commentID [Path variable] <Integer> Unique identifier of a comment record from a database.</Integer>
     ...
     * @param commentID [Path variable] <Integer> Unique identifier of a assignment's comment.
     ...
     * @param id [Path variable] <Integer> Unique identifier of an assignment to which a comment is being updated.
     * @param comment [Request body variable] <AssignmentCommentForCreationDto> object that is required to finish the operation.
     *               Required object's fields:
     ...
     * @param id [Path variable] <Integer> Unique identifier of an assignment to which a comment is being added.
     * @param comment [Request body variable] <AssignmentCommentForUpdateDto> object that is required to finish the operation.
     *               Required object's fields:
     ...
     * @param id [Path variable] <Integer> Unique identifier of the assignment for which the report should be created.
